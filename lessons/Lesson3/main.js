...
//     document.write(`<div>`);
//     document.write(`<h2><b>${coursesItem.title}</b></h2>`);
//     document.write(`<ul>`);
...
//     // all stuff here
//     document.write(`<div>`);
//     document.write(`<h2><b>${coursesArray[i].title}</b></h2>`);
//     document.write(`<ul>`);
...
let users = [
    {name: 'vasya', age: 31, status: false},
    {age: 30, status: true, surname: 'pupkin'},
    {name: 'kolya', age: 29, status: true, foo: 'bar'},
];
